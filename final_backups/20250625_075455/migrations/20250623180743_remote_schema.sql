...
ALTER TABLE ONLY "public"."class_offerings"
    ADD CONSTRAINT "class_offerings_term_id_class_id_course_id_key" UNIQUE ("term_id", "class_id", "course_id");
...
CREATE POLICY "Users can create holidays for their school" ON "public"."holidays" FOR INSERT WITH CHECK (("term_id" IN ( SELECT "t"."id"
   FROM (("public"."terms" "t"
...
CREATE POLICY "Users can delete holidays for their school" ON "public"."holidays" FOR DELETE USING (("term_id" IN ( SELECT "t"."id"
   FROM (("public"."terms" "t"
     JOIN "public"."academic_years" "ay" ON (("t"."academic_year_id" = "ay"."id")))
     JOIN "public"."profiles" "p" ON (("ay"."school_id" = "p"."school_id")))
  WHERE ("p"."id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update holidays for their school" ON "public"."holidays" FOR UPDATE USING (("term_id" IN ( SELECT "t"."id"
   FROM (("public"."terms" "t"
     JOIN "public"."academic_years" "ay" ON (("t"."academic_year_id" = "ay"."id")))
     JOIN "public"."profiles" "p" ON (("ay"."school_id" = "p"."school_id")))
  WHERE ("p"."id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view holidays for their school" ON "public"."holidays" FOR SELECT USING (("term_id" IN ( SELECT "t"."id"
   FROM (("public"."terms" "t"
     JOIN "public"."academic_years" "ay" ON (("t"."academic_year_id" = "ay"."id")))
     JOIN "public"."profiles" "p" ON (("ay"."school_id" = "p"."school_id")))
  WHERE ("p"."id" = "auth"."uid"()))));
