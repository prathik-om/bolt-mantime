-- =====================================================
-- CORRECTED CRUD OPERATIONS TESTING FOR ALL MODULES
-- =====================================================
...
BEGIN
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'STARTING CORRECTED CRUD OPERATIONS TESTING';
    RAISE NOTICE '=====================================================';
    RAISE NOTICE '';
    ...
    -- =====================================================
    -- 6. CLASSES CRUD TESTING (CORRECTED)
    -- =====================================================
    RAISE NOTICE '';
    RAISE NOTICE '6. TESTING CLASSES CRUD OPERATIONS (CORRECTED)...';
    
    -- CREATE (using correct schema - no section column)
    test_count := test_count + 1;
    test_name := 'classes_create';
    BEGIN
        INSERT INTO classes (id, school_id, name, grade_level)
        VALUES (test_class_id, test_school_id, 'Test Class', 9);
    ...
    -- =====================================================
    -- 8. CLASS OFFERINGS CRUD TESTING (CORRECTED)
    -- =====================================================
    RAISE NOTICE '';
    RAISE NOTICE '8. TESTING CLASS OFFERINGS CRUD OPERATIONS (CORRECTED)...';
    
    -- CREATE (using correct schema with required_hours_per_term)
    test_count := test_count + 1;
    ...
    -- =====================================================
    -- 11. HOLIDAYS CRUD TESTING (CORRECTED)
    -- =====================================================
    RAISE NOTICE '';
    RAISE NOTICE '11. TESTING HOLIDAYS CRUD OPERATIONS (CORRECTED)...';
    
    -- CREATE (using correct schema with reason instead of name)
    test_count := test_count + 1;
    test_name := 'holidays_create';
    BEGIN
        INSERT INTO holidays (id, academic_year_id, date, reason, school_id)
        VALUES (test_holiday_id, test_academic_year_id, '2024-12-25', 'Christmas Day', test_school_id);
    ...
    BEGIN
        UPDATE holidays SET reason = 'Updated Christmas Day' WHERE id = test_holiday_id;
        IF EXISTS (SELECT 1 FROM holidays WHERE id = test_holiday_id AND reason = 'Updated Christmas Day') THEN
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM schools WHERE id = test_school_id) AND
           ...
           NOT EXISTS (SELECT 1 FROM rooms WHERE school_id = test_school_id) AND
           NOT EXISTS (SELECT 1 FROM holidays WHERE school_id = test_school_id) THEN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'CORRECTED CRUD OPERATIONS TESTING SUMMARY';
    RAISE NOTICE '=====================================================';
