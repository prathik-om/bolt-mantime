  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "class_schedules_view"
      ...
      teacher_subject_qualifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "teacher_subject_qualifications_grade_id_fkey"
            columns: ["grade_id"]
            isOneToOne: false
            referencedRelation: "grades"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "teacher_subject_qualifications_subject_id_fkey"
            columns: ["subject_id"]
            isOneToOne: false
            referencedRelation: "class_schedules_view"
            referencedColumns: ["subject_id"]
          ...
          {
            foreignKeyName: "teacher_subject_qualifications_teacher_id_fkey"
            columns: ["teacher_id"]
            isOneToOne: false
            referencedRelation: "class_schedules_view"
            referencedColumns: ["teacher_id"]
      ...
      teaching_assignments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "class_schedules_view"
            referencedColumns: ["class_offering_id"]
          },
          {
      ...
      timetable_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "timetable_entries_teaching_assignment_id_fkey"
          ...
          {
            foreignKeyName: "timetable_entries_timeslot_id_fkey"
            columns: ["timeslot_id"]
            isOneToOne: false
            referencedRelation: "time_slots"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "timetable_entries_timetable_generation_id_fkey"
            columns: ["timetable_generation_id"]
            isOneToOne: false
            referencedRelation: "class_schedules_view"
            referencedColumns: ["timetable_generation_id"]
          },
          {
            foreignKeyName: "timetable_entries_timetable_generation_id_fkey"
            columns: ["timetable_generation_id"]
