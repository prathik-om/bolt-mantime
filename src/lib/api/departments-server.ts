...
/**
 * Get all departments for a school (server-side)
 */
...
/**
 * Get a single department by ID (server-side)
 */
...
/**
 * Create a new department (server-side)
 */
...
/**
 * Update an existing department (server-side)
 */
...
/**
 * Delete a department (server-side)
 */
...
/**
 * Get departments with statistics (teacher and course counts) - server-side
 */
...
/**
 * Check if a department name already exists in the school (server-side)
 */
...
/**
 * Get departments for dropdown/select components (server-side)
 */
...
/**
 * Bulk create departments from a list (server-side)
 */
